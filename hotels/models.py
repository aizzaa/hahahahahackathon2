...
class Rooms(models.Model):
    ...
    price = models.DecimalField(verbose_name='Цена/чел.', max_digits=10, decimal_places=2, null=False)
    descr = models.TextField(verbose_name='Описание комнаты')
    hotel_room = models.ForeignKey(Hotels, on_delete=models.CASCADE,
                                   verbose_name='Отель', related_name='rooms', default='hotel')
